...
function sendEmail(html) {
  ...
  nodeoutlook.sendEmail({
    ...
    to: 'arleymauricio@gmail.com,9f088c34.zyght.onmicrosoft.com@amer.teams.ms,magnolia.izarra@zyght.com,greidy.melendez@zyght.com,55e7153a.zyght.com@amer.teams.ms, daniel.valenzuela@zyght.com',
    subject: subject,
    html: html,
    text: '',
